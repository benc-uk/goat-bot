...
var region = process.env.MICROSOFT_VISION_API_REGION;
var key = process.env.MICROSOFT_VISION_API_KEY;
var VISION_URL = 'https://' + region + '.api.cognitive.microsoft.com/vision/v1.0/describe?maxCandidates=1&subscription-key=' + key;
...
function extractCaption(body) {
    if (body && body.description && body.description.captions && body.description.captions.length) {
        return { caption: body.description.captions[0].text, tags:body.description.tags };
    }
